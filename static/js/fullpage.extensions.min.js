...
!(function(e, t, n, o, i) {
  ...
  function re(e, t) {
    e = ce(e) ? e[0] : e;
    for (
      var n = null != t ? _(t, e.parentNode) : e.parentNode.childNodes,
        o = 0,
        i = 0;
      i < n.length;
      i++
  ...
  function he(e, t) {
    for (
      'string' == typeof t && (t = Te(t)), e.appendChild(t);
      e.firstChild !== t;
    ...
    function(Y, Z) {
          ...
          Pe &&
            ...
            (ve.destroy = function(n) {
              ...
              ['click', 'touchstart'].forEach(function(e) {
                ...
                n &&
                  ...
                  Oe(_(E + ', ' + j + ', ' + D)),
                  q(_(h), { height: '', 'background-color': '', padding: '' }),
                  q(_(O), { width: '' }),
                  q(Pe, {
                    height: '',
                    position: '',
                  ...
                  _(h + ', ' + O).forEach(function(e) {
                    Z.scrollOverflowHandler &&
                      Z.scrollOverflowHandler.remove(e),
                      de(e, z + ' ' + c + ' ' + d);
            ...
            (ve.test = {
              ...
              translate3dH: (function() {
                for (
                  var e = [], t = 0;
                  t < _(Z.sectionSelector, Pe).length;
                  t++
                )
            ...
            (ve.shared = { afterRenderActions: Pt }),
            (e.fullpage_api = ve),
            ...
            (function() {
              q(Pe, { height: '100%', position: 'relative' }),
                ue(Pe, n),
                ue(_('html'), a),
                (Ye = K()),
                de(Pe, l),
              ...
              for (var e = _(h), i = 0; i < e.length; i++) {
                ...
                s.setAttribute('data-fp-styles', s.getAttribute('style')),
                  ...
                  (ze = _(g)[0]),
                  q(m, { height: jt(m) + 'px' }),
                  Z.paddingTop && q(m, { 'padding-top': Z.paddingTop }),
                  Z.paddingBottom &&
                    q(m, { 'padding-bottom': Z.paddingBottom }),
                  void 0 !== Z.sectionsColor[S] &&
                    q(m, { 'background-color': Z.sectionsColor[S] }),
                  void 0 !== Z.anchors[S] &&
                    m.setAttribute('data-anchor', Z.anchors[S]),
                  (f = s),
                  (v = r),
                  void 0 !== Z.anchors[v] && J(f, c) && jn(Z.anchors[v], v),
                  Z.menu &&
                    Z.css3 &&
                    null != ge(_(Z.menu)[0], o) &&
                    ce.appendChild(_(Z.menu)[0]),
                  d > 0 ? Nt(s, u, d) : Z.verticalCentered && Dn(s);
              }
              var f, v, m, S;
              Z.fixedElements &&
                Z.css3 &&
                _(Z.fixedElements).forEach(function(e) {
                  ce.appendChild(e);
                }),
                Z.navigation &&
                  (function() {
                ...
                Z.scrollOverflow
                  ? (Ge = Z.scrollOverflowHandler.init(Z))
                  : Pt();
            })(),
            xt(!0),
              ...
              t.addEventListener(e, function(e) {
                ...
                t && ge(t, E + ' a')
                  ...
                  : Ae(t, L)
                    ...
                    : Ae(t, D)
                      ? Ln.call(t, e)
                      : (Ae(t, P) || null != ge(t, P)) && Tn.call(t, e);
              });
            }),
      ...
      function St(e, t) {
        ...
        if (Z.autoScrolling && !Z.scrollBar)
          q(le, { overflow: 'hidden', height: '100%' }),
            bt(it.recordHistory, 'internal'),
            q(Pe, { '-ms-touch-action': 'none', 'touch-action': 'none' }),
            null != n && $n(n.offsetTop);
        else if (
          (q(le, { overflow: 'visible', height: 'initial' }),
          bt(!1, 'internal'),
          q(Pe, { '-ms-touch-action': '', 'touch-action': '' }),
          no(Pe),
          null != n)
        ) {
      ...
      function Et(n) {
        n
          ? ((function() {
              ...
              'DOMMouseScroll' == i
                ? t[n](o + 'MozMousePixelScroll', Ft, !1)
                : t[n](o + i, Ft, !1);
            })(),
            Pe.addEventListener('mousedown', En),
            Pe.addEventListener('mouseup', xn))
          : (t.addEventListener
              ? (t.removeEventListener('mousewheel', Ft, !1),
                t.removeEventListener('wheel', Ft, !1),
                t.removeEventListener('MozMousePixelScroll', Ft, !1))
              : t.detachEvent('onmousewheel', Ft),
          ...
          : (to(e, 'all', 'm'),
            e
              ? (Et(!0),
                (Ne || je) &&
                  (Z.autoScrolling &&
                    (ce.removeEventListener(tt.touchmove, Vt, { passive: !1 }),
                    ce.addEventListener(tt.touchmove, Vt, { passive: !1 })),
                  ...
                  _(o)[0].addEventListener(tt.touchmove, Xt, { passive: !1 })))
              : (Et(!1),
                (Ne || je) &&
                  (Z.autoScrolling &&
                    (ce.removeEventListener(tt.touchmove, Xt, { passive: !1 }),
                    ce.removeEventListener(tt.touchmove, Vt, { passive: !1 })),
                  _(o)[0].removeEventListener(tt.touchstart, Gt),
                  _(o)[0].removeEventListener(tt.touchmove, Xt, {
                    passive: !1
                  })))),
          Le(Pe, 'setAllowScrolling', { value: e, directions: t });
      }
      function Lt(e, t) {
        void 0 !== t
          ? (t = t.replace(/ /g, '').split(',')).forEach(function(t) {
        ...
        if (!J(Pe, l)) {
          ...
          for (var n = _(h), o = 0; o < n.length; ++o) {
            var i = n[o],
              r = _(H, i)[0],
              a = _(O, i);
            Z.verticalCentered && q(_(S, i), { height: Wn(i) + 'px' }),
              q(i, { height: jt(i) + 'px' }),
          ...
          s && !oo('fadingEffect') && Tt(s + 1),
            ...
            xe(Z.afterResize) &&
              t &&
              Z.afterResize.call(Pe, e.innerWidth, e.innerHeight),
      ...
      function Rt(e) {
        ...
        e
          ? t ||
            ...
            Z.responsiveSlides &&
              ve.responsiveSlides &&
              ve.responsiveSlides.toSections(),
            Le(Pe, 'afterResponsive', e))
          : t &&
            (St(it.autoScrolling, 'internal'),
      ...
      function zt(e) {
        e.target != t &&
          Z.normalScrollElements.split(',').forEach(function(n) {
      ...
      function Nt(e, n, o) {
        ...
        (u.className = R),
          ...
          n.forEach(function(e) {
            q(e, { width: r + '%' }), Z.verticalCentered && Dn(e);
          });
        var d = _(k, e)[0];
        null != d && (0 !== re(_(g), h) || (0 === re(_(g), h) && 0 !== re(d)))
          ? (qn(d, 'internal'), ue(d, B))
          : ue(n[0], c);
      }
      function jt(e) {
        return Z.offsetSections && ve.offsetSections
          ? Math.round(ve.offsetSections.getWindowHeight(e))
          : K();
      }
      function Pt() {
        var e,
        ...
        ue(t, d),
          ...
          (!(e = Xn(Sn().section)) || (void 0 !== e && re(e) === re(ze))) &&
            xe(Z.afterLoad) &&
            qt('afterLoad', {
              activeSection: null,
              element: t,
      ...
      function Yt() {
        ...
        if (
          ...
          var t = oo('dragAndMove')
              ? Math.abs(ve.dragAndMove.getCurrentScroll())
              : ye(),
            n = 0,
            o = t + K() / 2,
            i =
              (oo('dragAndMove')
                ? ve.dragAndMove.getDocumentHeight()
                : ce.offsetHeight - K()) === t,
            r = _(h);
          if (i) n = r.length - 1;
          else if (t)
          ...
          if (!J((e = r[n]), c)) {
            ...
            m && ((s = m.getAttribute('data-anchor')), (a = re(m))),
              Ve &&
                (ue(e, c),
                de(we(e), c),
      ...
      function Wt(e) {
        if (Ze.m[e]) {
          var t = 'down' === e ? Mt : At;
          if (
            (ve.scrollHorizontally &&
              (t = ve.scrollHorizontally.getScrollSection(e, t)),
            Z.scrollOverflow)
          ) {
      ...
      function Xt(t) {
        ...
        if (Zt(t)) {
          ...
          (ft = o.y),
            (vt = o.x),
            _(H, n).length && Math.abs(dt - vt) > Math.abs(ut - ft)
              ? !Be &&
                Math.abs(dt - vt) > e.innerWidth / 100 * Z.touchSensitivity &&
                (dt > vt ? Ze.m.right && kt(n) : Ze.m.left && Ct(n))
              : Z.autoScrolling &&
                Ve &&
                Math.abs(ut - ft) > e.innerHeight / 100 * Z.touchSensitivity &&
                (ut > ft ? Wt('down') : ft > ut && Wt('up'));
        }
      }
      function Zt(e) {
      ...
      function Jt(e) {
        var t = e.offsetHeight,
          ...
          o = n,
          i =
            oo('dragAndMove') && ve.dragAndMove.isGrabbing
              ? ve.dragAndMove.isScrollingDown()
              : n > ht,
          r = o - Ye + t,
        ...
        return (
          ...
          Z.offsetSections &&
            ve.offsetSections &&
            (o = ve.offsetSections.getSectionPosition(i, o, e)),
          (ht = o),
          o
        );
      }
      function Kt(e, t, n) {
        if (null != e) {
          ...
          if (
            !(
              (l.activeSection == e && !De) ||
              (Z.scrollBar && ye() === l.dtop && !J(e, b))
            )
          ) {
            if (
              (null != l.activeSlide &&
                ((i = l.activeSlide.getAttribute('data-anchor')),
                (r = re(l.activeSlide))),
            ...
            io('parallax', 'apply', l),
              Z.autoScrolling &&
                ...
                ((u = l).isMovementUp
                  ? Se(_(g)[0], Ce(u.activeSection, h))
                  : me(_(g)[0], He(u.activeSection, h).reverse()),
                $n(_(g)[0].offsetTop),
                Qt(),
                ...
                (l = u)),
              oo('scrollOverflowReset') &&
                ve.scrollOverflowReset.setPrevious(l.activeSection),
              ...
              jn(
                l.anchorLink,
                null != (s = l).wrapAroundElements
                  ? s.isMovementUp ? _(h).length - 1 : 0
                  : s.sectionIndex
              );
          }
        }
      ...
      function qt(e, t) {
        var n,
          ...
          (r = Z.v2compatible
            ...
            : {
                afterRender: function() {
                  return { section: $t(_(g)[0]), slide: en(_(k, _(g)[0])[0]) };
                },
                onLeave: function() {
                  return {
      ...
      function nn(e) {
        ...
        null != (t = e).wrapAroundElements &&
          (t.isMovementUp
            ? Se(_(h)[0], t.wrapAroundElements)
            : me(_(h)[_(h).length - 1], t.wrapAroundElements),
          $n(_(g)[0].offsetTop),
          Qt(),
      ...
      function un(e) {
        ...
        function n(e) {
          ...
          for (e = e.replace(/[^A-Za-z0-9+/=]/g, ''); c < e.length; )
            (n =
              (t.indexOf(e.charAt(c++)) << 2) |
              ((r = t.indexOf(e.charAt(c++))) >> 4)),
      ...
      function dn(e) {
        ...
        var u = c ? un(rt[e]) : '',
          d =
            (u = u.split('_')).length > 1 &&
            u[1].indexOf(e, u[1].length - e.length) > -1;
        return (
          (!(u[0].indexOf(n, u[0].length - n.length) < 0 && s && a != u[0]) &&
            d) ||
          !s
        );
      }
      function fn(e) {
        e.forEach(function(e) {
          e.removedNodes[0] &&
            e.removedNodes[0].isEqualNode(at) &&
            (clearTimeout(st), (st = setTimeout(vn, 900)));
        });
      }
      function vn() {
        nt = !1;
      ...
      function pn(n) {
        (at = t.createElement('div')),
          ...
          'MutationObserver' in e &&
            new MutationObserver(fn).observe(t.body, {
              childList: !0,
              subtree: !1
            }),
      ...
      function hn() {
        at &&
          (nt || (Math.random() < 0.5 ? Re(ce, at) : fe(at, ce), (nt = !0)),
          at.setAttribute(
            'style',
            un(
      ...
      function bn(e) {
        ...
        9 === o
          ...
          : Ae(n, 'textarea') ||
            ...
            !Z.keyboardScrolling ||
            !Z.autoScrolling ||
            ([40, 38, 32, 33, 34].indexOf(o) > -1 && Ee(e),
            (Ie = e.ctrlKey),
      ...
      function On(e) {
        Ve &&
          (e.pageY < gt && Ze.m.up ? At() : e.pageY > gt && Ze.m.down && Mt()),
          (gt = e.pageY);
      }
      function kn(e, t, n) {
        var o = ge(e, h),
        ...
        (i.xMovement = Yn(i.prevSlideIndex, i.slideIndex)),
          ...
          !1 === qt('onSlideLeave', i)
            ...
            : (ue(t, c),
              de(we(t), c),
              i.localIsResizing || (sn(i.prevSlide), rn(t)),
              Cn(i),
              J(o, c) &&
                !i.localIsResizing &&
                Un(i.slideIndex, i.slideAnchor, i.anchorLink, i.sectionIndex),
              ve.continuousHorizontal && ve.continuousHorizontal.apply(i),
              lo() ? Hn(i) : Rn(e, i, !0),
              Z.interlockedSlides &&
                ve.interlockedSlides &&
                ((oo('continuousHorizontal') &&
                  void 0 !== n &&
                  n !== i.xMovement) ||
                  ve.interlockedSlides.apply(i)));
      }
      function Cn(e) {
        !Z.loopHorizontal &&
          Z.controlArrows &&
          (Me(_(X, e.section), 0 !== e.slideIndex),
      ...
      function Hn(e) {
        ...
        ve.continuousHorizontal && ve.continuousHorizontal.afterSlideLoads(e),
          ...
          Z.slidesNavigation &&
            null != t &&
            (de(_(u, t), c), ue(_('a', _('li', t)[n]), c)),
          e.localIsResizing ||
            (io('parallax', 'afterSlideLoads'),
      ...
      function Bn(e) {
        ...
        return de(e, r), q(e, { '-webkit-transition': t, transition: t });
      }
      function Nn(e) {
        return ue(e, r);
      }
      function jn(e, t) {
        ...
        (n = e),
          ...
          Z.menu &&
            null != o &&
            (de(_(u, o), c), ue(_('[data-menuanchor="' + n + '"]', o), c)),
          (i = e),
          (r = t),
          Z.navigation &&
            null != _(E)[0] &&
      ...
      function Zn(e, t) {
        ...
        if (null != n) {
          var o,
            ...
            r,
            l = (null ==
              (r = _(O + '[data-anchor="' + (o = t) + '"]', (i = n))[0]) &&
              ((o = void 0 !== o ? o : 0), (r = _(O, i)[o])),
            r);
          e === be || J(n, c)
            ? Gn(l)
            : Kt(n, function() {
      ...
      function $n(e) {
        ...
        if (Z.css3 && Z.autoScrolling && !Z.scrollBar)
          ...
          q(Pe, { top: -t + 'px' }), (ve.test.top = -t + 'px');
        else {
          var n = tn(t);
      ...
      function co(t, n, o, i) {
        var r,
          l =
            (r = t).self != e && J(r, C)
              ? r.scrollLeft
              : !Z.autoScrolling || Z.scrollBar ? ye() : r.offsetTop,
          a = n - l,
          s = 0;
        $e = !0;
        var c = function() {
      ...
      function uo(t, n) {
        !Z.autoScrolling || Z.scrollBar || (t.self != e && J(t, C))
          ? t.self != e && J(t, C) ? (t.scrollLeft = n) : t.scrollTo(0, n)
          : (t.style.top = n + 'px');
      }
      function fo(e, t) {
